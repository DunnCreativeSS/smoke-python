...
from smoke.utils import compat_bytes, compat_chr
import steem as stm
    ...
    def test_order_create(self):
        op = operations.LimitOrderCreate(
            **{
                "owner": "",
                "orderid": 0,
                "amount_to_sell": "0.000 SMOKE",
                "min_to_receive": "0.000 SMOKE",
                "fill_or_kill": False,
    ...
    def test_witness_update(self):
        op = operations.WitnessUpdate(
            **{
                ...
                "STM6zLNtyFVToBsBZDsgMhgjpwysYVbsQD6YhP3kRkQhANUB4w7Qp",
                "props": {
                    "account_creation_fee": "10.000 SMOKE",
